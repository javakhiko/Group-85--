...
console.log("my friend told me to tell my other friend to come".replaceAll('friend' , 'bro'))
...
// const saxeli
// saxeli = 'andria'
// console.log(saxeli) error

// const - ით შექმნილ ცვლადს ვერ შევუცვლით მნიშვნელობას
